...
class SkillRecordBuilder:
    ...
    def build(
        ...
        # Synthesize overall score (weighted average) and cap below 95 (max 94)
        ...
        overall_score = min(calculated_overall, 94)
        ...
        skill_record = {
            ...
            "evaluation": {
                "layer_1_ai_scoring": {
                    "structure": min(int(layer1.get("structure", 0)), 94),
                    "judgment": min(int(layer1.get("judgment", 0)), 94),
                    "clarity": min(int(layer1.get("clarity", 0)), 94),
                    "evidence_quality": min(int(layer1.get("evidence_quality", 0)), 94),
                },
                "layer_2_teammate_ratings": {
                    "designer_feedback": min(int(layer2.get("designer", 0)), 94),
                    "engineer_feedback": min(int(layer2.get("engineer", 0)), 94),
                    "qa_feedback": min(int(layer2.get("qa", 0)), 94),
                    "pm_feedback": min(int(layer2.get("pm", 0)), 94),
                },
                "layer_3_expert_review": {
                    "behavioral_signal": min(int(layer3.get("behavioral_signal", 0)), 94),
                    "pressure_handling": min(int(layer3.get("pressure_handling", 0)), 94),
                    "communication_quality": min(int(layer3.get("communication_quality", 0)), 94),
                    "risk_awareness": min(int(layer3.get("risk_awareness", 0)), 94),
                },
            },
            "overall_score": overall_score,
            "skills": {
                "problem_solving": min(int(layer1.get("judgment", 0)), 94),
                "communication": min(int(layer3.get("communication_quality", 0)), 94),
                "pressure_handling": min(int(layer3.get("pressure_handling", 0)), 94),
                "collaboration": min(int(layer2.get("pm", 0)), 94),
                "technical_reasoning": min(int(layer2.get("engineer", 0)), 94),
            },
